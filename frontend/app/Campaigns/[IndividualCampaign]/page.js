...
export default function IndividualCampaign(props) {
  ...
  return (
    <div className="flex flex-row justify-around bg-white text-black font-serif mb-[3%]">
      ...
      <div className="flex flex-col justify-center w-[40%]">
        <div className="w-[100%] ml-[6%]">
          ...
          <div className="flex w-[70%] mt-16">
            <div className="flex mb-2">
              <img
                src="\ReveilleX.jpg"
                className="object-cover object-[70%] rounded-full h-16 w-16"
              />
              <p className="ml-5 self-center">Username donated $___!</p>
            </div>
          </div>
