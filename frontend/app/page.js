...
export default function Home() {
    ...
    return (
        <main data-theme="light">
            <div className="hero h-[70vh] bg-cover bg-center relative" style={{ backgroundImage: 'url("/Campus.jpg")' }}>
                ...
                <div className="hero-content text-center absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                    <div className="max-w-screen-md">
                        ...
                        <p className="py-6 text-xl">
                            A platform for Texas A&M students, organizations, and alumni to raise
                            funds for their initiatives.
                        </p>
                        <a
                            href="/Campaigns"
                            className="btn bg-[#500000] btn-ghost text-white hover:bg-[#330b0b] "
                        >
                            <svg
            ...
            <section className="text-center pt-12 mt-2">
                ...
                <p className="py-6 w-[70vw] mx-auto text-xl">We provide a secure and reliable platform for fundraising. Our mission is to empower individuals and foster direct impact within our community.</p>
            </section>
            ...
            <section className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 p-10 mt-0 m-5">
                <div className="card w-96 bg-base-100 shadow-xl">
                    <div className="card-body">
                        <h2 className="card-title"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5 ">
                            ...
                            Secure Platform</h2>
                        <p className="text-lg">We prioritize the security of your funds and personal information.</p>
                    </div>
                </div>
                ...
                <div className="card w-96 bg-base-100 shadow-xl">
                    <div className="card-body">
                        <h2 className="card-title"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5">
                            ...
                            Funding</h2>
                        <p className="text-lg">All of the funds raised go directly to the campaign creators.</p>
                    </div>
                </div>
                ...
                <div className="card w-96 bg-base-100 shadow-xl">
                    <div className="card-body">
                        ...
                        <p className="text-lg">We're not just a platform, we're a community. Join us in supporting each other's dreams and initiatives.</p>
                    </div>
                </div>
            </section>
            ...
            <footer className="p-10 text-center">
                ...
                <p className="mt-6 text-xl">We're here to help and answer any question you might have.</p>
